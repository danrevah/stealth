...
6. Instead of passing the users RSA-4096 public key to the last node (that encrypts the returned data from the server), it's better that the client will generate a AES-256 key, to improve performance. 
